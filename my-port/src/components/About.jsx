  ...
  return (
    <div className='w-full flex flex-col lg:flex-row px-8 md:px-10 gap-10 lg:gap-20 lg:py-20 '>
      ...
      <div className='w-full flex flex-col'>
        ...
        Meet a proficient front-end web developer specializing in React JS. With a passion for building seamless user interfaces, this developer excels in crafting dynamic and visually appealing web applications. Bringing a problem-solving mindset, a keen eye for design, and a commitment to staying current with industry trends, they are dedicated to delivering innovative and top-notch solutions that elevate the user experience, whether collaborating with a team or working independently.
        </p>
        ...
        >
          <p className='flex gap-3 items-center justify-center rounded-full shadow-lg py-2 px-4 bg-[#030a1c] text-white cursor-pointer'>
            <FaUserAlt size={14} /> Umar Arshad
          </p>
          <p className='flex gap-3 items-center justify-center rounded-full shadow-lg py-2 px-4 bg-[#030a1c] text-white cursor-pointer'>
            <MdOutlineAlternateEmail size={14} /> umararshad563@gmail.com
          </p>
          <a
          ...
          >
            <BsWhatsapp size={14} /> +9203025429183
          </a>
          <p className='flex gap-3 items-center justify-center rounded-full shadow-lg py-2 px-4 bg-[#030a1c] text-white cursor-pointer'>
            <MdWifiCalling2 size={14} />  +9203025429183
          </p>
        </div>
      </div>
    </div>
